package apporio.com.vehicleapp.views;
 ...
 */
public class CustomRatingBarGreen extends LinearLayout {
    ...
    private int mStarOnResource = R.drawable.star_filled1;
    private int mStarOffResource = R.drawable.star_empty;
    private int mStarHalfResource = R.drawable.star_half_filled;
    ...
    public CustomRatingBarGreen(Context context) {
        super(context);
        init();
    }
    ...
    public CustomRatingBarGreen(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public CustomRatingBarGreen(Context context, AttributeSet attrs, int defStyle) {
